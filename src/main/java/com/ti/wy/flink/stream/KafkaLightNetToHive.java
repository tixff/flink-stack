 ...
 * @date 2021/2/24
 */
public class KafkaLightNetToHive {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaLightNetToHive.class);
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty("group.id", "kafkalighttohive_group0001");
        properties.setProperty("auto.offset.reset", "earliest");
        String consumer_topic = "IOT-xA707NOn1Lh1D4r";
        ...
        StreamingFileSink<String> sink = StreamingFileSink
                .forRowFormat(new Path("hdfs://dfscluster/user/hive/warehouse/ods.db/light_system"), new SimpleStringEncoder<String>("UTF-8"))
                /**
                 * 设置桶分配政策
                ...
                .withRollingPolicy(
                        ...
                        DefaultRollingPolicy.builder()
                                ...
                                .build())
                .withOutputFileConfig(new OutputFileConfig("light-system", ".txt"))
                .build();
        ...
        try {
            env.execute("kafka light-system write to hdfs");
        } catch (Exception e) {
            LOG.error("程序启动失败");
        }
